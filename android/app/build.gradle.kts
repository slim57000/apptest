...
android {
    namespace = "com.habitudeplus.habit_tracker"
    ...
    compileOptions {
        ...
        // Requis par flutter_local_notifications (utilise des APIs Java 8+
        // via desugaring sur les anciennes versions d'Android).
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        applicationId = "com.habitudeplus.habit_tracker"
